...
const Metrics = ({ data, highlightPathId, titleStart, titleFinish, entries, optionId, history, match }) => {

    const routeEntryId = match.params.entryId ? match.params.entryId : null

    const getEntryClassName = (entryId) => {
        ...
        <React.Fragment>
            ...
            <section className="entry-grid">
                {entries.map(entry => {
                    return (
                        <div
                            className={getEntryClassName(entry._id)}
                        ...
                        <div className="aggregate-data">
                            ...
                            <div className="common-links">
                                ...
                                <div className="link-list">
                                    {sortedEntryFrequency.map((entry, i) => (
                                        <div className="link-data">
                                            <span className="link-count">({entry.count })</span>
                                            <span className="link-title">{ entry.title }</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
